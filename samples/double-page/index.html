...
<body>
	<div>
		<audio src="pages/musica.mp3" controls autoplay loop></audio>
	</div>
</div>
...
<div class="flipbook-viewport">
	<div class="container">
		<div class="flipbook">
			...
			<div class="double" style="background-image:url(pages/8.jpg)">
				<video src="pages/video.mp4" width="50%" height="100%" controls  ></video>
			</div>
